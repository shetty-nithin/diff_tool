...
from diff_generator.differ import generate_diff_using_plain_lcs
...
def main():
    ...
    diff = generate_diff_using_plain_lcs(A_norm, B_norm, A_raw, B_raw) 
    html = render_html(diff)

    with open(output, "w", encoding="utf-8") as f:
        f.write(html)

    print("Success! Difference generated using plain lcs algorithm")
